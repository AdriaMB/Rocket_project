...
public class FXMLDocumentController implements Initializable {
    ...
    public void initChart( File f, int measure) throws Exception{
        ...
        switch(m){
            ...
            case 2:
                name = "Temperature";
                axisName = "Temperature (ºC)";
                break;
            case 3:
                name = "Pressure";
                axisName = "Pressure (hPa)";
                break;
            default:
    ...
    private void fillCharts() throws Exception{
        ...
        while(scan.hasNext()){
            ...
            Tooltip tooltip = new Tooltip("X: " + timeStamp + " s\nY: " + dataForThisChart);
            Tooltip.install(aux.getNode(), tooltip);
            
            
            series.getData().add( aux ); // We put that value in the series
            
            System.out.print(name + ":  " + dataForThisChart + "  "); // Debugging
