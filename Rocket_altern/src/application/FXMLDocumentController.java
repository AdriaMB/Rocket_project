...
public class FXMLDocumentController implements Initializable {
    ...
    XYChart.Series seriesPressure = new XYChart.Series(); // XYChart.Series are necessary for depicting the data in the lineChart
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        heightChart.setCreateSymbols(true);
        
        paneAxisH.visibleProperty().bind(fileLoaded); // If a file is loaded, the boolean will be true and the red axis will show up
    ...
    private void takeHeightData(MouseEvent event) {
        ...
        */
        ...
        if(fileLoaded.get()){
            ...
            xAxisLine.setLayoutX(limitXAxisLine);
            yAxisLine.setLayoutY(limitYAxisLine);
